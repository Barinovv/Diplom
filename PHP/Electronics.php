...
<div class="container">         
  <div class="post-wrap card">                     
    <div class="wrapper-item">
      <div class="ads">  
      <img class="ads__img" src="../images/s8.jpg">
        <div class="wrapper-right">        
          <div class="ads__title">LG Smart TV<h3>
          </div>    
           <div class="ads__text">	<p><ul>
<li>Название: LG32LN613V </li>
<li>Диагональ 127см </li>
<li>3D-Video: встроенное </li>
<br/>
            </div>
            <button class="btn btn_ads">
              <a href="LG.html"> Подробнее</a>
                </button>
        </div>
      </div> 
