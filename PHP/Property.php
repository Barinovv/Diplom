...
<div class="container">         
  <div class="post-wrap card">                     
    <div class="wrapper-item">
      <div class="ads">  
      <img class="ads__img" src="../images/s6.jpg">
        <div class="wrapper-right">        
          <div class="ads__title">Коттедж 80 кв/м<h3>
          </div>    
           <div class="ads__text">	<p><ul>
<li>Площадь участка: 18 сот. </li>
<li>Расстояние до города: 16 км </li>
<li>Этажей в доме: 2 </li>
<br/>
            </div>
            <button class="btn btn_ads">
              <a href="Cottage.html"> Подробнее</a>
                </button>
        </div>
      </div> 
    
        <div class="ads">  
          <img class="ads__img" src="../images/s7.jpg">
            <div class="wrapper-right">   
              <div class="ads__titlee">Гараж </div>
                 <div class="ads__texxt">
                    <ul>
                      <li>Тип гаража: кирпичный</li>
                      <li>Цвет: оранжевый</li>
                      <li>Охрана: нет</li>
                    </ul>
                  <br/>
                  <button class="btn btn_ads">
                    <a href="Garage.html">   Подробнее </a>
                   </button>
                  </div>
          </div>
          </div>
