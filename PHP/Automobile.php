...
<div class="container">         
  <div class="post-wrap card">                     
    <div class="wrapper-item">
      <div class="ads">  
      <img class="ads__img" src="../images/s1.jpg">
        <div class="wrapper-right">        
          <div class="ads__title">Ваз 2110<h3>
          </div>    
           <div class="ads__text">	<p><ul>
<li>Год выпуска: 2009</li>
<li>Состояние срееднее</li>
<li>Сломана передняя стойка</li>
<br/>
            </div>
            <button class="btn btn_ads">
              <a href="VAZ.html"> Подробнее</a>
                </button>
        </div>
      </div> 
      <div class="ads">  
        <img class="ads__img" src="../images/s3.jpg">
          <div class="wrapper-right">        
            <div class="ads__title">MERCEDES S Class<h3>
            </div>    
             <div class="ads__text">	<p><ul>
  <li>Год выпуска: 2018</li>
  <li>Состояние с завода</li>
  <li>Зимняя резина в комплекте</li>
  <br/>
              </div>
                  <button class="btn btn_ads">
                   <a href="Mercedes.html">   Подробнее </a>
                  </button>
          </div>
        </div> 
        <div class="ads">  
          <img class="ads__img" src="../images/s4.jpg">
            <div class="wrapper-right">   
              <div class="ads__titlee">Renault Kaptur</div>
                 <div class="ads__texxt">
                    <ul>
                      <li>Год выпуска: 2016</li>
                      <li>Состояние с отличное</li>
                      <li>Автомат, полный привод</li>
                      <li>Дата подачи: 11.06.2019</li>
                    </ul>
                  <br/>
                  <button class="btn btn_ads">
                    <a href="Kaptur.php">   Подробнее </a>
                   </button>
                  </div>
          </div>
          </div>
